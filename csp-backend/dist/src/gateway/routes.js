...
router.get("/agents", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield agentController.getAllAgents(req, res);
    }
    catch (error) {
...
router.post("/conversations/:id/voice", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield voiceController.processVoice(req, res);
    }
    catch (error) {
...
router.get("/conversations/:id/voice", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield voiceController.getVoiceExchanges(req, res);
    }
    catch (error) {
